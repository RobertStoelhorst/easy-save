...
export const Entertainment = (props) => {
  ...
  const calculateTotal = () =>
    Number(coffeeExpense * coffeePeriod) +
    Number(lunchesExpense * lunshesPeriod) +
    Number(snackExpense * snackPeriod) +
    Number(cigaretteExpense * cigarettePeriod) +
    Number(drinkExpense * drinkPeriod) +
    Number(barExpense * barPeriod) +
    Number(restaurantExpense * restaurantPeriod) +
    Number(bookExpense * bookPeriod) +
    Number(newsExpense * newsPeriod) +
    Number(moviesExpense * moviesPeriod) +
    Number(holidayExpense * holidayPeriod) +
    Number(giftExpense * giftPeriod) +
    ...
    <div className="">
      <div className="accordion-section">
        <button className={`accordion ${setActive}`} onClick={toggleAccordion}>
          ...
          <CurrencyFormat
            value={-props.entertainmentTotal}
            displayType={"text"}
          ...
          <form>
            <div className="category">
              ...
              <input
                ...
                type="text"
                onChange={(e) => setCoffeeExpense(e.target.value)}
                placeholder="$0"
              />
              <select
                onChange={(e) => setCoffeePeriod(e.target.value)}
            ...
            <div className="category">
              ...
              <input
                className="input-field"
                type="text"
                onChange={(e) => setLunchesExpense(e.target.value)}
                placeholder="$0"
              />
              <select
                onChange={(e) => setLunchesPeriod(e.target.value)}
                className="period-list"
                name=""
              >
                <option value="52">Weekly</option>
            ...
            <div className="category">
              ...
              <input
                className="input-field"
                type="text"
                onChange={(e) => setSnackExpense(e.target.value)}
                placeholder="$0"
              />
              <select
                onChange={(e) => setSnackPeriod(e.target.value)}
                className="period-list"
                name=""
              >
                <option value="52">Weekly</option>
            ...
            <div className="category">
              ...
              <input
                className="input-field"
                type="text"
                onChange={(e) => setCigaretteExpense(e.target.value)}
                placeholder="$0"
              />
              <select
                onChange={(e) => setCigarettePeriod(e.target.value)}
                className="period-list"
                name=""
              >
                <option value="52">Weekly</option>
            ...
            <div className="category">
              ...
              <input
                className="input-field"
                type="text"
                onChange={(e) => setDrinkExpense(e.target.value)}
                placeholder="$0"
              />
              <select
                onChange={(e) => setDrinkPeriod(e.target.value)}
                className="period-list"
                name=""
              >
                <option value="52">Weekly</option>
            ...
            <div className="category">
              ...
              <input
                className="input-field"
                type="text"
                onChange={(e) => setBarExpense(e.target.value)}
                placeholder="$0"
              />
              <select
            ...
            <div className="category">
              ...
              />
              <select
                onChange={(e) => setRestaurantPeriod(e.target.value)}
                className="period-list"
                name=""
              >
                <option value="52">Weekly</option>
            ...
            <div className="category">
              ...
              <input
                className="input-field"
                type="text"
                onChange={(e) => setBookExpense(e.target.value)}
                placeholder="$0"
              />
              <select
                onChange={(e) => setBookPeriod(e.target.value)}
                className="period-list"
                name=""
              >
                <option value="52">Weekly</option>
            ...
            <div className="category">
              ...
              <input
                className="input-field"
                type="text"
                onChange={(e) => setNewsExpense(e.target.value)}
                placeholder="$0"
              />
              <select
            ...
            <div className="category">
              ...
              <input
                className="input-field"
                type="text"
                onChange={(e) => setMoviesExpense(e.target.value)}
                placeholder="$0"
              />
              <select
                onChange={(e) => setMoviesPeriod(e.target.value)}
                className="period-list"
                name=""
              >
                <option value="52">Weekly</option>
            ...
            <div className="category">
              ...
              <input
                className="input-field"
                type="text"
                onChange={(e) => setHolidayExpense(e.target.value)}
                placeholder="$0"
              />
              <select
                onChange={(e) => setHolidayPeriod(e.target.value)}
                className="period-list"
                name=""
              >
                <option value="52">Weekly</option>
            ...
            <div className="category">
              ...
              <input
                className="input-field"
                type="text"
                onChange={(e) => setGiftExpense(e.target.value)}
                placeholder="$0"
              />
              <select
                onChange={(e) => setGiftPeriod(e.target.value)}
                className="period-list"
                name=""
              >
                <option value="52">Weekly</option>
