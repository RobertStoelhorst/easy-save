...
export const Insurance = (props) => {
  ...
  const calculateTotal = () =>
    Number(carExpense * carPeriod) +
    Number(homeExpense * homePeriod) +
    Number(personalExpense * personalPeriod) +
    Number(healthExpense * healthPeriod) +
    Number(carLoanExpense * carLoanPeriod) +
    Number(creditExpense * creditPeriod) +
    Number(loansExpense * loansPeriod) +
    Number(debtExpense * debtPeriod) +
    Number(savingsExpense * savingsPeriod) +
    Number(investmentsExpense * investmentsPeriod) +
    Number(charityExpense * charityPeriod) +
        ...
        <div className="accordion-container">
          <form>
            <div className="category">
              ...
              />
              <select
                onChange={(e) => setCarPeriod(e.target.value)}
            ...
            <div className="category">
              ...
              />
              <select
                onChange={(e) => setHomePeriod(e.target.value)}
                className="period-list"
                name=""
              >
                <option value="52">Weekly</option>
            ...
            <div className="category">
              ...
              />
              <select
                onChange={(e) => setPersonalPeriod(e.target.value)}
                className="period-list"
                name=""
              >
                <option value="52">Weekly</option>
            ...
            <div className="category">
              ...
              />
              <select
                onChange={(e) => setHealthPeriod(e.target.value)}
                className="period-list"
                name=""
              >
                <option value="52">Weekly</option>
            ...
            <div className="category">
              ...
              <input
                className="input-field"
                type="text"
                onChange={(e) => setCarLoanExpense(e.target.value)}
                placeholder="$0"
              />
              <select
                onChange={(e) => setCarLoanPeriod(e.target.value)}
                className="period-list"
                name=""
              >
                <option value="52">Weekly</option>
            ...
            <div className="category">
              ...
              <input
                className="input-field"
                type="text"
                onChange={(e) => setCreditExpense(e.target.value)}
                placeholder="$0"
              />
              <select
            ...
            <div className="category">
              ...
              <input
                className="input-field"
                type="text"
                onChange={(e) => setLoansExpense(e.target.value)}
                placeholder="$0"
              />
              <select
                onChange={(e) => setLoansPeriod(e.target.value)}
                className="period-list"
                name=""
              >
                <option value="52">Weekly</option>
            ...
            <div className="category">
              ...
              />
              <select
                onChange={(e) => setDebtPeriod(e.target.value)}
                className="period-list"
                name=""
              >
                <option value="52">Weekly</option>
            ...
            <div className="category">
              ...
              <input
                className="input-field"
                type="text"
                onChange={(e) => setInvestmentsExpense(e.target.value)}
                placeholder="$0"
              />
              <select
                onChange={(e) => setInvestmentsPeriod(e.target.value)}
                className="period-list"
                name=""
              >
                <option value="52">Weekly</option>
            ...
            <div className="category">
              ...
              <input
                className="input-field"
                type="text"
                onChange={(e) => setCharityExpense(e.target.value)}
                placeholder="$0"
              />
              <select
                onChange={(e) => setCharityPeriod(e.target.value)}
                className="period-list"
                name=""
              >
                <option value="52">Weekly</option>
